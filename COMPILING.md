...
When finished, you will find the precompiled versions for various platforms in the `dist` folder.
        ...
        rdio-scanner-darwin-amd64-v6.6.3-yak.0.0.1.zip
        rdio-scanner-darwin-arm64-v6.6.3-yak.0.0.1.zip
        rdio-scanner-freebsd-amd64-v6.6.3-yak.0.0.1.zip
        rdio-scanner-linux-386-v6.6.3-yak.0.0.1.zip
        rdio-scanner-linux-amd64-v6.6.3-yak.0.0.1.zip
        rdio-scanner-linux-arm64-v6.6.3-yak.0.0.1.zip
        rdio-scanner-linux-arm-v6.6.3-yak.0.0.1.zip
        rdio-scanner-windows-amd64-v6.6.3-yak.0.0.1.zip
