...
2. Extract the contents of the archive somewhere on your computer. The configuration file and the database file will be created in this same folder.
        ...
        Archive:  ../rdio-scanner-freebsd-amd64-v6.6.3-yak.0.0.1.zip
...
3. Run the executable.
        ...
        ----------------------------------
        2024/01/03 08:16:36 server started
        2024/01/03 08:16:36 main interface at http://pc-freebsd:3000
        2024/01/03 08:16:36 admin interface at http://pc-freebsd:3000/admin
...
> Because privileged ports requires root privileges, we need to run the command as _root_.
        ...
        Rdio Scanner v6.6.3-yak.0.0.1
        ----------------------------------
        2024/01/03 08:19:38 server started
        2024/01/03 08:19:38 main interface at http://pc-freebsd
        2024/01/03 08:19:38 admin interface at http://pc-freebsd/admin
...
You can use your own SSL certificates that match your domain name with `-ssl_cert_file` and `-ssl_key_file`. If your certificate comes with an intermediate CA certificate, simply add its contents to the standard certificate file.
        ...
        Rdio Scanner v6.6.3-yak.0.0.1
        ----------------------------------
        2024/01/03 10:34:29 server started
        2024/01/03 10:34:29 main interface at http://pc-freebsd
        2024/01/03 10:34:29 main interface at https://pc-freebsd
        2024/01/03 10:34:29 admin interface at https://pc-freebsd/admin
...
You don't want to have to type everytime a long list of arguments. No problem, you can save your advanced configuration to a file by adding the **-config_save** argument.
        ...
        > -ssl_listen :443                                    \
        > -config_save
        2024/01/03 10:37:00 rdio-scanner.ini file created
...
Then simply run [Rdio Scanner](https://github.com/chuot/rdio-scanner) without any arguments.
        ...
        Rdio Scanner v6.6.3-yak.0.0.1
        ----------------------------------
        2024/01/03 10:38:28 server started
        2024/01/03 10:38:29 main interface at http://pc-freebsd
        2024/01/03 10:38:29 main interface at https://pc-freebsd
        2024/01/03 10:38:29 admin interface at https://pc-freebsd/admin
