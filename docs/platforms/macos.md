...
2. Extract the contents of the archive somewhere on your computer. The configuration file and the database file will be created in this same folder.
        ...
        > ~/Downloads/rdio-scanner-macos-arm64-v6.6.3-yak.0.0.1.zip 
        Archive:  /Users/rdio/Downloads/rdio-scanner-macos-arm64-v6.6.3-yak.0.0.1.zip
...
3. Run the executable.
        ...
        Rdio Scanner v6.6.3-yak.0.0.1
        ----------------------------------
        2024/01/03 08:38:06 server started
        2024/01/03 08:38:06 main interface at http://macos.local:3000
        2024/01/03 08:38:06 admin interface at http://macos.local:3000/admin
...
Here we want our [Rdio Scanner](https://guthub.com/chuot/rdio-scanner) instance to listen for connections on the standard HTTP port.
        ...
        Rdio Scanner v6.6.3-yak.0.0.1
        ----------------------------------
        2024/01/03 08:48:03 server started
        2024/01/03 08:48:03 main interface at http://macos.local
        2024/01/03 08:48:03 admin interface at http://macos.local/admin
...
You can use your own SSL certificates that match your domain name with `-ssl_cert_file` and `-ssl_key_file`. If your certificate comes with an intermediate CA certificate, simply add its contents to the standard certificate file.
        ...
        Rdio Scanner v6.6.3-yak.0.0.1
        ----------------------------------
        2024/01/03 08:50:58 server started
        2024/01/03 08:50:58 main interface at http://macos.local
        2024/01/03 08:50:58 main interface at https://macos.local
        2024/01/03 08:50:58 admin interface at https://macos.local/admin
...
You don't want to have to type everytime a long list of arguments. No problem, you can save your advanced configuration to a file by adding the **-config_save** argument.
        ...
        > -ssl_listen :443                       \
        > -config_save
        2024/01/03 08:52:24 rdio-scanner.ini file created
...
Then simply run [Rdio Scanner](https://github.com/chuot/rdio-scanner) without any arguments.
        ...
        Rdio Scanner v6.6.3-yak.0.0.1
        ----------------------------------
        2024/01/03 08:54:08 server started
        2024/01/03 08:54:08 main interface at http://macos.local
        2024/01/03 08:54:08 main interface at https://macos.local
        2024/01/03 08:54:08 admin interface at https://macos.local/admin
