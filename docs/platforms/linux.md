...
2. Extract the contents of the archive somewhere on your computer. The configuration file and the database file will be created in this same folder.
        ...
        > ~/Downloads/rdio-scanner-linux-amd64-v6.6.3-yak.0.0.1.zip 
        Archive:  /home/rdio/Downloads/rdio-scanner-linux-amd64-v6.6.3-yak.0.0.1.zip
...
3. Run the executable.
        ...
        ----------------------------------
        2024/01/03 09:11:48 server started
        2024/01/03 09:11:48 main interface at http://pc-linux:3000
        2024/01/03 09:11:48 admin interface at http://pc-linux:3000/admin
...
> Because privileged ports requires root privileges, we need to run the command as _root_.
        ...
        Rdio Scanner v6.6.3-yak.0.0.1
        ----------------------------------
        2024/01/03 09:14:00 server started
        2024/01/03 09:14:00 main interface at http://pc-linux
        2024/01/03 09:14:00 admin interface at http://pc-linux/admin
...
You can use your own SSL certificates that match your domain name with `-ssl_cert_file` and `-ssl_key_file`. If your certificate comes with an intermediate CA certificate, simply add its contents to the standard certificate file.
        ...
        Rdio Scanner v6.6.3-yak.0.0.1
        ----------------------------------
        2024/01/03 09:16:47 server started
        2024/01/03 09:16:47 main interface at http://pc-linux
        2024/01/03 09:16:47 main interface at https://pc-linux
        2024/01/03 09:16:47 admin interface at https://pc-linux/admin
...
You don't want to have to type everytime a long list of arguments. No problem, you can save your advanced configuration to a file by adding the **-config_save** argument.
        ...
        > -ssl_listen :443                           \
        > -config_save
        2024/01/03 09:19:29 rdio-scanner.ini file created
...
Then simply run [Rdio Scanner](https://github.com/chuot/rdio-scanner) without any arguments.
        ...
        Rdio Scanner v6.6.3-yak.0.0.1
        ----------------------------------
        2024/01/03 09:20:40 server started
        2024/01/03 09:20:40 main interface at http://pc-linux
        2024/01/03 09:20:40 main interface at https://pc-linux
        2024/01/03 09:20:40 admin interface at https://pc-linux/admin
