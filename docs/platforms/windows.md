...
2. Extract the contents of the archive somewhere on your computer. The configuration file and the database file will be created in this same folder.
        ...
        C:\Users\rdio\rdio-scanner> tar -xvf ^
            ..\downloads\rdio-scanner-windows-amd64-v6.6.3-yak.0.0.1.zip
        x rdio-scanner.exe
        x rdio-scanner.pdf
...
3. Run the executable.
        ...
        ----------------------------------
        2024/01/03 13:48:48 server started
        2024/01/03 13:48:48 main interface at http://pc-windows:3000
        2024/01/03 13:48:48 admin interface at http://pc-windows:3000/admin
...
Here we want our [Rdio Scanner](https://guthub.com/chuot/rdio-scanner) instance to listen for connections on the standard HTTP port.
        ...
        Rdio Scanner v6.6.3-yak.0.0.1
        ----------------------------------
        2024/01/03 10:53:31 server started
        2024/01/03 10:53:31 main interface at http://pc-windows
        2024/01/03 10:53:31 admin interface at http://pc-windows/admin
...
You can use your own SSL certificates that match your domain name with `-ssl_cert_file` and `-ssl_key_file`. If your certificate comes with an intermediate CA certificate, simply add its contents to the standard certificate file.
        ...
        Rdio Scanner v6.6.3-yak.0.0.1
        ----------------------------------
        2024/01/03 11:05:43 server started
        2024/01/03 11:05:43 main interface at http://pc-windows
        2024/01/03 11:05:43 main interface at https://pc-windows
        2024/01/03 11:05:43 admin interface at https://pc-windows/admin
...
You don't want to have to type everytime a long list of arguments. No problem, you can save your advanced configuration to a file by adding the **-config_save** argument.
        ...
        C:\Users\rdio\rdio-scanner>rdio-scanner ^
            ...
            -ssl_listen :443                    ^
            -config_save
        2024/01/03 11:08:28 rdio-scanner.ini file created
...
Then simply run [Rdio Scanner](https://github.com/chuot/rdio-scanner) without any arguments.
        ...
        Rdio Scanner v6.6.3-yak.0.0.1
        ----------------------------------
        2024/01/03 11:11:28 server started
        2024/01/03 11:11:28 main interface at http://pc-windows
        2024/01/03 11:11:28 main interface at https://pc-windows
        2024/01/03 11:11:28 admin interface at https://pc-windows/admin
